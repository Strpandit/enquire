# -*- encoding: utf-8 -*-
# stub: blueprinter 1.2.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.authors = ["Procore Technologies, Inc.".freeze]
  s.date = "2025-09-11"
  ...
  s.email = ["opensource@procore.com".freeze]
  s.homepage = "https://github.com/procore-oss/blueprinter".freeze
